      ...
      <div className="flex md:flex-row flex-col gap-10 w-full px-4 sm:px-12 lg:px-24 py-28">
        <div className="flex flex-1 flex-col "> {/*md:mr-10 w-full px-2*/}
          ...
          <button
            ...
            className="flex flex-row justify-center items-center max-w-md my-5 bg-sky-600 p-3 rounded-full cursor-pointer hover:bg-sky-700 text-slate-50"
        ...
        <div className="flex flex-col flex-1 items-center md:items-end justify-start w-full md:mt-0 mt-10  ">
          ...
          <div className="p-5 sm:w-96 w-80 flex flex-col justify-start items-center  blue-glassmorphism">
            <Input
